        ...
        <div className="App">
            ...
            <div className="SelectorContainer">
                <select className="Selector" value={selectedLanguage} onChange={handleDropdownChange}>
                    ...
                    <option value="en-EN" className="Options">
                        English
                    </option>
                    <option value="it-IT" className="Options">
                        Italian
                    </option>
                    <option value="zh-CN" className="Options">
                        Mandarin
                    </option>
                    <option value="ja-JA" className="Options">
                        Japanese
                    </option>
                    <option value="ne-NE" className="Options">
                        Nepalese
                    </option>
                    <option value="ar-SA" className="Options">
                        Arabic
                    </option>
                </select>
            </div>
